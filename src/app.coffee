  ...
  view: () ->
    return m(".content", [
      m("p", "So far our app has looked very 1990s. Mithril view templates
        ...
        In this lesson we'll learn that every aspect of HTML and CSS
      ...
      m(".dothis", "open src/index.jade"),
      m("p", m.trust("We've given our app a modern look by adding a link to the
        <a href='http://getbootstrap.com/' target='_blank'>Bootstrap</a> CSS library
      ...
      m("p", m.trust("<code>m(\"tag\", { attributes }, children)</code><br />
        This method produces virtual elements, which are then rendered to the
      ...
      m(".dothis", "See how the href attributes are appended to the anchor tags
...
# It allows for [\n] [\t] and [\ ]
      ...
      m("p[style='white-space:pre']", "
        ...
        a new HTML tag. Mithril provides the m.trust() helper method to allow\n
        for more familiar HTML coding."),
